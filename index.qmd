...
This report provides a reproducible pipeline for processing, [geocoding](https://en.wikipedia.org/wiki/Address_geocoding), and classifying [CNPJ](https://en.wikipedia.org/wiki/CNPJ)s from the Brazilian Annual Social Information Report ([RAIS](https://www.rais.gov.br/)) of the Brazilian Ministry of Labor and Employment ([MTE](https://www.gov.br/trabalho-e-emprego)) using the [Locais-Nova](https://doi.org/10.1590/S2237-96222025v34.20240361.en) scale.

For instructions on how to run the pipeline, see the repository [README](https://github.com/cem-usp/locais-nova-rais-geocoding/blob/main/README.md).
...
- Brazilian  Ministry of Labor and Employment ([MTE](https://www.gov.br/trabalho-e-emprego)): Data on food establishments from the Annual Social Information Report ([RAIS](https://www.rais.gov.br/)) related to 2022, provided by request, used for company identification.
...
## Import Agencies and Municipalities (TOM) Data
...
```{r}
#| label: Import Agencies and Municipalities (TOM) Data
...
## Cross-Reference Data with RFB Data

```{r}
#| label: Cross-Reference Data with RFB Data

establishment_data <-
  establishment_data |>
  left_join(rfb_data, by = "cnpj") |>
  relocate(starts_with("locais_nova"), .after = postal_code)
```
...
osf_id <- paste0("https://osf.io/", "p5ufj")
