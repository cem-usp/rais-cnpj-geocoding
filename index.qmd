...
For instructions on how to run the pipeline, see the repository [README](https://github.com/cem-usp/rais-cnpj-geocoding/blob/main/README.md).
...
- Brazilian  Ministry of Labor and Employment ([MTE](https://www.gov.br/trabalho-e-emprego)): Data on food retail establishments from the Annual Social Information Report ([RAIS](https://www.rais.gov.br/)) provided by request, used for company identification.
